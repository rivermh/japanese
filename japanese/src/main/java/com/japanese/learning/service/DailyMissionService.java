...
public class DailyMissionService {
    ...
    public DailyMission today(UserAccount account) {
        ...
        if (existing.isPresent()) {
            ...
            return mission(true, session.completedCount() > 0, session.reviewCount(), session.completedReviewCount(),
    ...
    private DailyMission mission(boolean snapshot, boolean started, int reviewTarget, int reviewDone,
        ...
        return new DailyMission(time.today(), snapshot, started, total > 0 && completed >= total,
