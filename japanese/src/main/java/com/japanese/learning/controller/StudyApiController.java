...
public class StudyApiController {
    ...
    public StudyApiController(LearningService learningService, CurrentUserService currentUserService,
        ...
        this.streakService = streakService; this.todayStudySessions = todayStudySessions;
    }
    ...
    public List<ContentSummary> relearn(@PathVariable String target) {
        return learningService.relearningCards(currentUserService.currentAccount(), parseTarget(target));
    }
